...
//     document.write(`
//                    NAME — ${simpson.name} <br> SURNAME — ${simpson.surname} <br> AGE — ${simpson.age} <br>
...
//     const simpson = simpsons[i];
//     document.write(`<h2>
//                    ${simpson.name} ${simpson.surname}, age is   — ${simpson.age}
//                     </h2>`);
...
//     document.write(`<h3 class="product-card">${product.title}, Price -  ${product.price}, </h3> `)
